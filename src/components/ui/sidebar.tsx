  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'duration-300 fixed inset-y-0 z-10 hidden h-svh transition-[width] ease-in-out md:flex flex-col',
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'group-data-[mobile-sheet=true]:group-data-[state=expanded]:hidden',
        className
      )}
      {...props}
    />
